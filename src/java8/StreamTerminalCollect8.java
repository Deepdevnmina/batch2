...
public class StreamTerminalCollect8 {
	...
	public static void main(String[] args) {
		...
		Map<Customer,List<Integer>> customersSet=customers.stream().sorted((c1,c2)->c2.getDoe().compareTo(c1.getDoe())).collect(Collectors.groupingBy(Function.identity(),
